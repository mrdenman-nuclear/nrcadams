...
This page is updated once a day and presents the last week of posted ADAMS documents. The last update was at `r Sys.time()`.

# Making RSS files

The following code shows the user how they can generate RSS files to help keep updated with their favorite ADAMS search results. Note that `write_RSS()` is an internal function and requires `:::` to be incalled instead of `::`.
...
nrcadams::docket_codex |>
  ...
  nrcadams::hyperlink_file_to_name(name_vct = Project, url_vct = `RSS File`)|>
