...
This page is updated once a day and presents the last week of posted ADAMS documents. The last update was at `r Sys.time() |> lubridate::ymd_hms() |> lubridate::with_tz("America/New_York")` EST.
...
```{r}
plot_min_date = "2018-01-01" |> lubridate::ymd()
...
grouped_dockets = combined_dockets |>
  ...
  dplyr::filter(`Document Date` > plot_min_date)
